...
- Ambient profile: `hyatt_marked_region_event_life_reference_match_v1`
- Camera flashes: 180, all inside user-marked magenta walkway/balcony bands.
- Balloon rises: 28, all from the three user-marked green table-bouquet clusters.
