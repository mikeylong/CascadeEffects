...
This spec is for subject-first, source-preserving documentary generation. The model should be given concrete image problems, not abstract composition ideology.
