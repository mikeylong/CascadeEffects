...
- require title, description, chapter labels, hashtags, and tags to be drafted or QA'd through `/Users/mike/Agents_CascadeEffects/references/skills/youtube_metadata_copywriting_v1/SKILL.md`; record `youtube_metadata_copywriting_read`;
